...
<head>
    ...
    <link rel="icon" type="image/ico" href="/assets/images/MetalFengLogo.ico"/>
    <link rel="shortcut icon" type="image/ico" href="/assets/images/MetalFengLogo.ico"/>
    ...
    <div class="game-container">
        ...
        <div class="game-details-container">
            ...
            <ul class="details-list">
                ...
                <li>Tools: Unity, C#, Git, Piskel, Trello</li>
                <li>Team Size: 2</li>
        ...
        <div class="game-details-container">
            ...
            <ul class="details-list">
                <li>Concept, Gameplay, and Enemy Designs</li>
    ...
    <div class="game-container">
        ...
        <div class="game-details-container">
            ...
            <ul class="details-list">
                ...
                <li>Tools: Unity, C#, Git, ClickUp</li>
                <li>Team Size: 5</li>
